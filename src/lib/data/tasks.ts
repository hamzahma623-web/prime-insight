...
export const tasks: Task[] = [
  { id: "t-501", title: "Reinigungsintervalle Umkleide/Dusche erhöhen (Abendschicht)", locationId: "loc-cgn", priority: "critical", status: "open", assignee: "Sarah Klein", due: "2026-07-16T00:00:00Z", category: "Sauberkeit", source: "Jarvis" },
  ...
  { id: "t-503", title: "Rezeptions-Schulung Freundlichkeit & Reaktionszeit", locationId: "loc-cgn", priority: "high", status: "open", assignee: "Sarah Klein", due: "2026-07-22T00:00:00Z", category: "Personal", source: "Jarvis" },
  ...
  { id: "t-512", title: "Best-Practice Sauberkeit Hamburg dokumentieren", locationId: "loc-ham", priority: "low", status: "done", assignee: "Jonas Bruhn", due: "2026-07-10T00:00:00Z", category: "Wissenstransfer", source: "Jarvis" },
];
